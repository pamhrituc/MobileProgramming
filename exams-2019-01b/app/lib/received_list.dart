...
class ReceivedList extends StatefulWidget {
  final String user;
  ReceivedList({Key key, @required this.user}) : super(key: key);
  @override
  _ReceivedListState createState() => _ReceivedListState(user);
}
...
class _ReceivedListState extends State<ReceivedList> {
  ...
  _ReceivedListState(String user) : this.user = user;
  @override
  void initState() {
    print(user);
  ...
  Widget messagesWidget() {
    ...
    return FutureBuilder(
      future: provider.getReceived(user),
